...
Sticklebacks with a high-grade parasite A infection had a mean increased diplo intensity of a .17(95%CI; : ) increase from the control sticklebacks with a mean 1.33 diplo intensity (95%CI; : ). This was statistically significant(t~214~ = 4.04, *p* = 0.0000732). 
Sticklebacks with a low-grade parasite A infection on average had a mean decreased diplo intensity of -0.08(95%CI; : ) from the control sticklebacks which was not statistically significant (t~214~ = -1.27, *p* = 0.21).
