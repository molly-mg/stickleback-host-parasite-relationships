...
To establish the biological cost of parasite A on sticklebacks, each treatment level was compared with initial stickleback length (mm), then subdivided into 
